...
# Datenbank: ROLLOUT
# Verarbeitungszeit: 2024-09-21 23:07:48 +0000
# ************************************************************
...
CREATE TABLE `Auftrag` (
  ...
  `Installation_geplant` datetime(3) DEFAULT NULL,
  `Installation_Tag` datetime(3) DEFAULT NULL,
  `Abbruchdatum` datetime(3) DEFAULT NULL,
  `Kabeltausch_erledigt` tinyint(1) NOT NULL DEFAULT '0',
  `Problemfall` tinyint(1) NOT NULL DEFAULT '0',
  `Abschluss_Techniker` tinyint(1) NOT NULL DEFAULT '0',
  `Abschluss_Buero` tinyint(1) NOT NULL DEFAULT '0',
  `Unterschrift_Kunde` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Unterschrift_Techniker` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Auftrag_ID`),
  KEY `Auftrag_Kunde_ID_fkey` (`Kunde_ID`),
  KEY `Auftrag_Mitarbeiter_ID_fkey` (`Mitarbeiter_ID`),
  CONSTRAINT `Auftrag_Kunde_ID_fkey` FOREIGN KEY (`Kunde_ID`) REFERENCES `Kunde` (`Kunde_ID`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Auftrag_Mitarbeiter_ID_fkey` FOREIGN KEY (`Mitarbeiter_ID`) REFERENCES `Mitarbeiter` (`Mitarbeiter_ID`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `Geraet` (
  ...
  `Status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Geraet_ID`),
  KEY `Geraet_Kunde_ID_fkey` (`Kunde_ID`),
  CONSTRAINT `Geraet_Kunde_ID_fkey` FOREIGN KEY (`Kunde_ID`) REFERENCES `Kunde` (`Kunde_ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Kommentar` (
  `Kommentar_ID` int NOT NULL AUTO_INCREMENT,
  `Auftrag_ID` int DEFAULT NULL,
  `Problemfall_Kommentar` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Kommentar_Datum` datetime(3) NOT NULL,
  PRIMARY KEY (`Kommentar_ID`),
  KEY `Kommentar_Auftrag_ID_fkey` (`Auftrag_ID`),
  CONSTRAINT `Kommentar_Auftrag_ID_fkey` FOREIGN KEY (`Auftrag_ID`) REFERENCES `Auftrag` (`Auftrag_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Kunde` (
  `Kunde_ID` int NOT NULL AUTO_INCREMENT,
  `Kunde_Marktnummer` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Kunde_Strasse` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Kunde_Hausnummer` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Kunde_PLZ` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Kunde_Ort` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Kunde_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Mitarbeiter` (
  `Mitarbeiter_ID` int NOT NULL AUTO_INCREMENT,
  `Mitarbeiter_Vorname` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Mitarbeiter_Name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Mitarbeiter_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Paket` (
  ...
  `Status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Paket_ID`),
  KEY `Paket_Kunde_ID_fkey` (`Kunde_ID`),
  CONSTRAINT `Paket_Kunde_ID_fkey` FOREIGN KEY (`Kunde_ID`) REFERENCES `Kunde` (`Kunde_ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Route` (
  ...
  `Mitarbeiter_ID` int DEFAULT NULL,
  `Auftrag_ID` int DEFAULT NULL,
  `Installation_Tag` datetime(3) NOT NULL,
  PRIMARY KEY (`Route_ID`),
  KEY `Route_Mitarbeiter_ID_fkey` (`Mitarbeiter_ID`),
  KEY `Route_Auftrag_ID_fkey` (`Auftrag_ID`),
  CONSTRAINT `Route_Auftrag_ID_fkey` FOREIGN KEY (`Auftrag_ID`) REFERENCES `Auftrag` (`Auftrag_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Route_Mitarbeiter_ID_fkey` FOREIGN KEY (`Mitarbeiter_ID`) REFERENCES `Mitarbeiter` (`Mitarbeiter_ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `User` (
  ...
  UNIQUE KEY `User_Mitarbeiter_ID_key` (`Mitarbeiter_ID`),
  CONSTRAINT `User_Mitarbeiter_ID_fkey` FOREIGN KEY (`Mitarbeiter_ID`) REFERENCES `Mitarbeiter` (`Mitarbeiter_ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
